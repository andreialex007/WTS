        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Invoices_Stores_FromStoreId",
                        column: x => x.FromStoreId,
                        principalTable: "Stores",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Invoices_Suppliers_FromSupplierId",
                        column: x => x.FromSupplierId,
                        principalTable: "Suppliers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Invoices_Warehouses_FromWarehouseId",
                        column: x => x.FromWarehouseId,
                        principalTable: "Warehouses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Invoices_Stores_ToStoreId",
                        column: x => x.ToStoreId,
                        principalTable: "Stores",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Invoices_Suppliers_ToSupplierId",
                        column: x => x.ToSupplierId,
                        principalTable: "Suppliers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Invoices_Warehouses_ToWarehouseId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Invoices_FromStoreId",
                table: "Invoices",
                column: "FromStoreId");

            migrationBuilder.CreateIndex(
                name: "IX_Invoices_FromSupplierId",
                table: "Invoices",
                column: "FromSupplierId");

            migrationBuilder.CreateIndex(
                name: "IX_Invoices_FromWarehouseId",
                table: "Invoices",
                column: "FromWarehouseId");

            migrationBuilder.CreateIndex(
                name: "IX_Invoices_ToStoreId",
                table: "Invoices",
                column: "ToStoreId");

            migrationBuilder.CreateIndex(
                name: "IX_Invoices_ToSupplierId",
                table: "Invoices",
                column: "ToSupplierId");

            migrationBuilder.CreateIndex(
                name: "IX_Invoices_ToWarehouseId",
                table: "Invoices",
